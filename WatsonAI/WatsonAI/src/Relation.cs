...
namespace WatsonAI
{
  ...
  public struct Relation
  {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="T:WatsonAI.Relation"/> struct.
    /// </summary>
    ...
    // /// <summary>
    // /// The exclusive disjuction (<c>xor</c>) of two <see cref="WatsonAI.Relation"/>.
    // /// </summary>
    // /// <returns>A new <see cref="WatsonAI.Relation"/> containing the exclusive disjucntion of the Relation in <c>lhs</c> and <c>rhs</c>.</returns>
    // /// <param name="lhs">The left hand side of the expression.</param>
    // /// <param name="rhs">The right hand side of the expression.</param>
    // public static Relation operator ^(Relation lhs, Relation rhs)
    //   => new Relation(lhs.Relation ^ rhs.Relation);
    ...
    /// <summary>
    /// Serves as a hash function for a <see cref="T:WatsonAI.Relation"/> object.
    /// </summary>
