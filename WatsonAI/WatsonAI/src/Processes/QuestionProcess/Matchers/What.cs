...
namespace WatsonAI
{
  public class What : IEntityMatcher
  {
    ...
    public What(CommonPatterns cp, KnowledgeQuery query, Associations associations, Thesaurus thesaurus)
    {
      this.cp = cp;
      this.query = query;
    ...
    public bool MatchOn(Parse tree)
    {
      ...
      var isAdjQuestion = adjQuestion.Match(tree).HasValue;
      //Console.WriteLine(isAdjQuestion);
